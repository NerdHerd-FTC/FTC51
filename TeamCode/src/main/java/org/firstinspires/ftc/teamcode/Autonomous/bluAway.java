...
@Autonomous(name="Blue Away from Audience")
@Disabled
public class bluAway extends autoExample {
    @Override
...
//        }
        ...
        telemetry.addLine("Blue Alliance, Away from Audience, Front facing backdrop");
        telemetry.update();
